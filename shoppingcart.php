	...
	if(!isset($_SESSION["cart_array"]) || count($_SESSION["cart_array"]) < 1){
		...
		foreach($_SESSION["cart_array"] as $each_product){
			...
			$cartOutput .= '<tr><td><img style="border: 2px solid;" src="images/product/'.$prodNo.'.jpg" width="150" height="120" /></td> 
				...
				<td align="right">Ksh'.$prodPrice.'</td> 
				<td align="right">Ksh '.$pricetotal.'</td>
		...
		$cartOutput .= '<tr>
                            ...
                            <td colspan="2" align="left" style="background:#ccc; font-weight:bold;">Ksh '.$cartTotal.' </td>
...
<div id="main_wrapper">
	<div id="main_header">
        ...
        <div id="header_right">
            <div id="main_search">
                <form action="products.php" method="get" method="post" name="search_form">
