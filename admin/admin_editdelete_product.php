...
<title>Live - Administrator</title>
</head>
<body id="adminpage">
<div id="main_wrapper">
	<div id="main_header">
		...
		<div id="content">
			...
			<table cellpadding="0" cellspacing="0" border="0">
				<tr>
					...
					<td class="border border_ts border_bs col_1">
                    <input type="number" name="txtProdId" placeholder="EnterID"value="<?php echo $prodID; ?>" /></td>
				...
				<tr>
					...
					<td colspan="2" class="border border_bs border_rs">
                    <input class="col_3 marginleft_3" type="file" name="fileField" <?php echo $imageFile; ?> /></td>
				</tr>
				<tr>
					<td class="border border_ls border_bs col_1">Product Name:</td>
					<td colspan="3" class="border border_bs border_rs col_2">
                    <input class="col_4" type="text" name="ProdName" placeholder="prodname" value="<?php echo $prodName; ?>" <?php echo $txtProdName; ?> /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="3" class="border border_bs border_rs col_2"><select name="selProdCat" class="col_2" value="<?php echo $prodCat; ?>" <?php echo $txtProdCat; ?> ><option></option><option>Phone</option><option>Tools</option><option>Fashion</option></select></td>
				</tr>
				<tr>
