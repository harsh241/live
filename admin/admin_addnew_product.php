		...
		<div id="content">
			...
			<table cellpadding="0" cellspacing="0" border="0">
				...
				<tr>
					...
					<td colspan="3" class="border border_bs border_rs col_2"><select name="selProdCat" class="col_2"><option></option><option>Phone</option><option>Tools</option><option>Fashion</option></select></td>
				</tr>
				<tr>
